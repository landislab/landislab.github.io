...
Only recently, statistical event-based models have been used in a phylogenetic context to estimate ancestral species ranges.
In particular, we are interested how biogeography and paleogeography can be used to estimate phylogenetic divergence times and how regional features shape biogeographic processes of speciation, extinction, and dispersal.
